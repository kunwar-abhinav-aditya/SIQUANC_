...
public class BuildController {
    ...
    public Map<String, ArrayList<String>> getComponents(@RequestBody BuildRequest buildRequest) {
        return buildService.getComponents(buildRequest);
    }

    @PostMapping(path="/bestpipelines", produces = {MediaType.APPLICATION_JSON_VALUE})
    public ArrayList<ArrayList<String>> getBestPipelines(@RequestBody Map<String, ArrayList<String>> componentsPerTask) {
